...
| -- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| A1 | A failed command is worth one turn of the model's reading, never the run. | on the bench, 4 edit errors in one harness and 8 in another were all followed by a corrected turn (ADR-0012, the bench, not yet written)        | C1's failed-RESULT rule should end the run on some errors |
